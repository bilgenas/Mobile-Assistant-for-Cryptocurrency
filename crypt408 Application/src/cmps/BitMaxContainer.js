...
class BitMaxContainer extends Component {
  ...
  componentDidMount() {
    if(this._isMounted){
      ...
      fetch('https://bitmax.io/api/v1/depth?symbol=ETH-USDT').then((response) => response.json()).then((responseData) => {
          this.setState({
      ...
      fetch('https://bitmax.io/api/v1/depth?symbol=ETH-BTC').then((response) => response.json()).then((responseData) => {
          this.setState({
      ...
      fetch('https://bitmax.io/api/v1/depth?symbol=ETC-USDT').then((response) => response.json()).then((responseData) => {
          this.setState({
      ...
      fetch('https://bitmax.io/api/v1/depth?symbol=LTC-USDT').then((response) => response.json()).then((responseData) => {
          this.setState({
...
export default BitMaxContainer
